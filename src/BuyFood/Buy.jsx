...
const Buy = ({buy}) => {
    let {image,food_name,description,food_price,buy_button} = buy
    return (
        <div>
            <div className="card bg-base-100 shadow-xl mb-6 md:my-12">
             ...
             <div className="card-body items-center text-center">
               ...
               <div className="card-actions">
                 <button className="btn btn-primary bg-green-500 border-none text-white">{buy_button}</button>
               </div>
             </div>
           </div>
        </div>
